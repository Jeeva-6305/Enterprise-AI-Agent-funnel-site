    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '520px', textAlign: 'center', padding: '2.25rem 2rem' }}>
        ...
        <p style={{ color: '#475569', fontSize: '0.9375rem', marginBottom: '1.5rem', lineHeight: '1.5' }}>
          Thank you, <strong>{lead.full_name || lead.fullName}</strong>. Your organization (<strong>{lead.company_name || lead.companyName}</strong>) has been registered. You can now watch the full Document Extraction platform demonstration.
        </p>
